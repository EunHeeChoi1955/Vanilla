...
//2-1. 선택된 버튼을  등록 후 사용
    ...
    var b = '5';
        ...
        console.log('a == b ',  a == b );  //참(true) 잘못된 결과

        
        console.log('a === b ',  a === b );  //거짓(false) 잘된거임


//슬라이드\
 //클래스 이름(한개인경우) querySelector사용
var slideWrap =  document.querySelector('.slide-wrap');

//태그이름 여러개(복수)
 //클래스 이름(여러개인경우) querySelectorAll사용
var aTag =  document.querySelectorAll('.nav  a');

//클래스 이름(1개인경우) querySelector사용
...
var nextBtn =  document.querySelector('#nextBtn');
    ...
    //클래스와 태그이름은 중복가능
    //그래서 document.querySelectorAll 선택자로 사용하는경우는
    //반드시 선택자에 배열 구조로 곽괄호를 사용한다.  [0] [1] [2] ..


    //slideWrap.style = 'left: calc(-1920px*0)'; //css

    slideWrap.style = 'left:' + (-1920*cnt) + 'px';

    console.log('slideWrap[0] ', slideWrap[0] );
    console.log('slideWrap2 ',  slideWrap2 );

    console.log('aTag ',  aTag ); //개체의 배열 내용 나타나고
