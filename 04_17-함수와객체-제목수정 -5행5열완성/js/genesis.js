...
(function(){
    var genesis = {
            ...
            section13Fn: function(){
                //5행 5열 1씩 증가 값 1 ~ 25 채우기

                var $output = document.querySelector('#section13 .output');
                var $googoodanBtn = document.querySelector('#section13 .googoodan-btn');
                var txt = '';
                var k=0;


                    function arrayFn(){
                        for(var i=1; i<=5; i++){ //행 1 ~ 5
                            txt += '<tr>';
                            for(var j=1; j<=5; j++){ //열 1 ~5
                                k++; //1 2 3 4...... 25
                                txt += '<td>' +  k  + '</td>';
                            }
                            txt += '</tr>';
            ...
            section14Fn: function(){
                 //5행 5열 1씩 감소 값 25 ~ 1 채우기

                 var $output = document.querySelector('#section14 .output');
                 var $googoodanBtn = document.querySelector('#section14 .googoodan-btn');
                 var txt = '';
                 var k=25;
